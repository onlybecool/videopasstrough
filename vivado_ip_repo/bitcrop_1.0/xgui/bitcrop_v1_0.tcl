...
proc init_gui { IPINST } {
	...
	set C_S_AXI_TDATA_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_S_AXI_TDATA_WIDTH ]
set_property tooltip {AXI4Stream sink: Data Width} $C_S_AXI_TDATA_WIDTH
	set C_M_AXI_TDATA_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_M_AXI_TDATA_WIDTH ]
